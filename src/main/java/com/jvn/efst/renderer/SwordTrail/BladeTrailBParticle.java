...
public class BladeTrailBParticle extends SpriteTexturedParticle {
    ...
    public BladeTrailBParticle(ClientWorld level, LivingEntityPatch entitypatch, int life, int jointid, Trail trail, IAnimatedSprite animatedSprite, int trailType, ParticleTrail particleTrail) {
        super(level,0,0,0);
        //this.joint = joint;
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            //TkkEpic.getInstance().broadcast("tkk createParticle");
            int eid = (int)Double.doubleToLongBits(x);
            int modid = (int)Double.doubleToLongBits(y);
            int life = (int)Double.doubleToLongBits(z);
            ...
            if (entity != null) {
                ...
                if (entitypatch != null) {
                    ...
                    Trail trail=(ySpeed>=0 ? entitypatch.mainTrail: entitypatch.offTrail);
                    ...
                    //TkkEpic.getInstance().broadcast("tkk return new BladeTrailBParticle");
                    return new BladeTrailBParticle(level, entitypatch,life, jointId, trail, spriteSet,trailType,particleTrai);
                }
            }
            //TkkEpic.getInstance().broadcast("tkk return null");
            return null;
        }
