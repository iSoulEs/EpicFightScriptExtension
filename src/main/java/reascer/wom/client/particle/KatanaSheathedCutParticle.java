...
public class KatanaSheathedCutParticle extends HitParticle {
    public KatanaSheathedCutParticle(ClientWorld world, double x, double y, double z, IAnimatedSprite animatedSprite) {
    ...
    @OnlyIn(Dist.CLIENT)
    /* loaded from: 旧版[付费的史诗战斗mod]WeaponsOfMinecraft-1.6.jar:reascer/wom/client/particle/KatanaSheathedCutParticle$Provider.class */
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            KatanaSheathedCutParticle particle = new KatanaSheathedCutParticle(worldIn, x, y, z, this.spriteSet);
            return particle;
        }
    }
}
