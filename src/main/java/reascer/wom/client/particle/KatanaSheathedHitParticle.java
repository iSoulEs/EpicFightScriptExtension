...
public class KatanaSheathedHitParticle extends MetaParticle {
    /* JADX WARN: Type inference failed for: r0v20, types: [double] */
    public KatanaSheathedHitParticle(ClientWorld world, double x, double y, double z, double width, double height, double _null) {
        super(world, x, y, z);
        ...
        this.level.addParticle( WOMEpicFightParticle.KATANA_SHEATHED_CUT.get(), this.x, this.y, this.z, 0.0d, 0.0d, 0.0d);
        char c = 0;
        for (int i = 0; i < 6; i++) {
    ...
    @OnlyIn(Dist.CLIENT)
    /* loaded from: 旧版[付费的史诗战斗mod]WeaponsOfMinecraft-1.6.jar:reascer/wom/client/particle/KatanaSheathedHitParticle$Provider.class */
