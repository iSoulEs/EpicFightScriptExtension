...
public class StateSpectrum {
	public final Set<StatesInTime> timePairs = Sets.newHashSet();

	public void readFrom(StateSpectrum.Blueprint blueprint) {
	...
	public static class StatesInTime {
		public float start;
		public float end;
		public Set<Pair<StateFactor<?>, ?>> states;
	...
	public static class Blueprint {
		public StatesInTime currentState;
		public Set<StatesInTime> timePairs = Sets.newHashSet();
