...
public class ConfigManager {
	...
	//tkk
	public static final ForgeConfigSpec.BooleanValue AUTO_ARMOR_WEIGHT_STUNARMOR;
	...
	static {
		...
		AUTO_ARMOR_WEIGHT_STUNARMOR = server.define("tkk.auto_armor_weight_stunarmor", false);
