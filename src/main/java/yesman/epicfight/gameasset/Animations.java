...
public class Animations {
	...
	public static StaticAnimation BIPED_STEP_FORWARD_GHOST;
	public static StaticAnimation BIPED_STEP_BACKWARD_GHOST;
	public static StaticAnimation BIPED_STEP_LEFT_GHOST;
	public static StaticAnimation BIPED_STEP_RIGHT_GHOST;
	...
	public static StaticAnimation BIPED_MOB_SWORD_DUAL3_DUALAXE;
	...
	public static StaticAnimation AXE_AUTO1_DUNT;
	public static StaticAnimation AXE_AUTO2;
	public static StaticAnimation AXE_AUTO2_DUNT;
	public static StaticAnimation AXE_DASH;
	public static StaticAnimation AXE_DASH_LINK;
	public static StaticAnimation AXE_DASH_DUNT;
	...
	public static StaticAnimation FIST_AUTO3_LONG;
	public static StaticAnimation FIST_DASH;
	public static StaticAnimation FIST_AIR_SLASH;
	public static StaticAnimation FIST_AIR_SLASH_KNOCKDOWN;
	...
	public static StaticAnimation SPEAR_TWOHAND_AIR_SLASH_DUNT;
	...
	public static StaticAnimation SICKLE_TWOHAND_AUTO1;
	public static StaticAnimation SICKLE_TWOHAND_AUTO2;
	public static StaticAnimation SICKLE_TWOHAND_AUTO3;
	public static StaticAnimation SICKLE_TWOHAND_AUTO4;
	public static StaticAnimation SWORD_AUTO1;
	public static StaticAnimation SWORD_AUTO1_DUNT;
	public static StaticAnimation SWORD_AUTO2;
	public static StaticAnimation SWORD_AUTO3;
	public static StaticAnimation SWORD_AUTO3_DUNT;
	public static StaticAnimation SWORD_AUTO3_PLUS;
	public static StaticAnimation SWORD_DASH;
	public static StaticAnimation SWORD_AIR_SLASH;
	public static StaticAnimation SWORD_AIR_SLASH_CONTINUOUS_CUTTING;
	public static StaticAnimation SWORD_AIR_SLASH_HEAVY_CHOPPING;
	...
	public static StaticAnimation SWORD_DUAL_AUTO2_RAPID;
	public static StaticAnimation SWORD_DUAL_AUTO3;
	public static StaticAnimation SWORD_DUAL_AUTO3_RAPID;
	public static StaticAnimation SWORD_DUAL_DASH;
	public static StaticAnimation SWORD_DUAL_AIR_SLASH;
	public static StaticAnimation SWORD_DUAL_AIR_SLASH_DUNT;
	...
	public static StaticAnimation LONGSWORD_AUTO2_DUNT;
	public static StaticAnimation LONGSWORD_AUTO3;
	public static StaticAnimation LONGSWORD_DASH;
	public static StaticAnimation LONGSWORD_DASH2;
	public static StaticAnimation LONGSWORD_AIR_SLASH;
	public static StaticAnimation LONGSWORD_AIR_SLASH_JUMP;
	public static StaticAnimation LONGSWORD_AIR_SLASH_DUNT;
	...
	public static StaticAnimation KATANA_AUTO2_DUNT;
	public static StaticAnimation KATANA_AUTO3;
	public static StaticAnimation KATANA_AUTO4;
	...
	public static StaticAnimation GREATSWORD_AUTO3_LONGNIGHT;
	public static StaticAnimation GREATSWORD_AUTO4_LONGNIGHT;
	public static StaticAnimation GREATSWORD_AUTO2_DUNT;
	public static StaticAnimation GREATSWORD_DASH;
	public static StaticAnimation GREATSWORD_DASH_DUNT;
	public static StaticAnimation GREATSWORD_HEAVY_CHOPPING;
	public static StaticAnimation GREATSWORD_HEAVY_CHOPPING_LONGNIGHT;
	public static StaticAnimation GREATSWORD_AIR_SLASH;
	public static StaticAnimation GREATSWORD_AIR_SLASH2;
	public static StaticAnimation GREATSWORD_AIR_SLASH_LONGNIGHT;
	...
	public static StaticAnimation DAGGER_AUTO3_DUNT;
	...
	public static StaticAnimation DAGGER_DUAL_AUTO2_RAPID;
	public static StaticAnimation DAGGER_DUAL_AUTO3;
	public static StaticAnimation DAGGER_DUAL_AUTO3_DUNT;
	public static StaticAnimation DAGGER_DUAL_AUTO4;
	public static StaticAnimation DAGGER_DUAL_AUTO4_HOLD;
	...
	public static StaticAnimation SWEEPING_EDGE_CORRECT;
	...
	public static StaticAnimation FATAL_DRAW_NEW;
	...
	public static StaticAnimation BLADE_RUSH_SWEEP_AWAY;
	...
	public static StaticAnimation VANILLA_LETHAL_SLICING_START1;
	public static StaticAnimation VANILLA_LETHAL_SLICING_START2;
	public static StaticAnimation VANILLA_LETHAL_SLICING_START3;
	public static StaticAnimation VANILLA_LETHAL_SLICING_START4;
	public static StaticAnimation VANILLA_LETHAL_SLICING_START5;
	public static StaticAnimation VANILLA_LETHAL_SLICING_START6;
	public static StaticAnimation VANILLA_SWORD_DASH1;
	public static StaticAnimation VANILLA_DAGGER_AUTO1;
	public static StaticAnimation VANILLA_DAGGER_AUTO2;
	public static StaticAnimation VANILLA_DAGGER_AUTO3;

	public static StaticAnimation VANILLA_LONGSWORD_AUTO1;
	public static StaticAnimation VANILLA_LONGSWORD_AUTO2;
	public static StaticAnimation VANILLA_LONGSWORD_AUTO3;
	public static StaticAnimation VANILLA_LONGSWORD_DASH;
	public static StaticAnimation VANILLA_SWORD_AUTO1;
	public static StaticAnimation VANILLA_SWORD_AUTO2;
	public static StaticAnimation VANILLA_SWORD_AUTO3;
	public static StaticAnimation VANILLA_AXE_DASH;
	public static StaticAnimation VANILLA_GREATSWORD_DASH;
	public static StaticAnimation VANILLA_TACHI_DASH;
	public static StaticAnimation VANILLA_SWORD_DUAL_AUTO1;
	public static StaticAnimation VANILLA_SWORD_DUAL_AUTO2;
	public static StaticAnimation VANILLA_SWORD_DUAL_AUTO3;
	public static StaticAnimation VANILLA_SWORD_DUAL_DASH;
	public static StaticAnimation VANILLA_SWORD_DUAL_AIR_SLASH;
	public static StaticAnimation VANILLA_DAGGER_DUAL_AUTO1;
	public static StaticAnimation VANILLA_DAGGER_DUAL_AUTO2;
	public static StaticAnimation VANILLA_DAGGER_DUAL_AUTO3;
	public static StaticAnimation VANILLA_DAGGER_DUAL_AUTO4;
	public static StaticAnimation VANILLA_GREATSWORD_AIR_SLASH;
	public static StaticAnimation VANILLA_KATANA_AUTO1;
	public static StaticAnimation VANILLA_KATANA_AUTO2;
	public static StaticAnimation VANILLA_KATANA_AUTO3;
	public static StaticAnimation VANILLA_SWEEPING_EDGE;
	public static StaticAnimation VANILLA_DANCING_EDGE;
	public static StaticAnimation VANILLA_SPEAR_SLASH;

	public static StaticAnimation VANILLA_SPEAR_ONEHAND_AUTO;

	public static StaticAnimation VANILLA_SPEAR_TWOHAND_AUTO1;

	public static StaticAnimation VANILLA_SPEAR_TWOHAND_AUTO2;

	public static StaticAnimation VANILLA_GREATSWORD_AUTO1;

	public static StaticAnimation VANILLA_GREATSWORD_AUTO2;




	public static StaticAnimation FREE_COLLIDER_WITHER_SKELETON_ATTACK1;
	public static StaticAnimation FREE_COLLIDER_WITHER_SKELETON_ATTACK2;
	public static StaticAnimation FREE_COLLIDER_WITHER_SKELETON_ATTACK3;
	public static StaticAnimation FREE_COLLIDER_VINDICATOR_SWING_AXE1;
	public static StaticAnimation FREE_COLLIDER_VINDICATOR_SWING_AXE2;
	public static StaticAnimation FREE_COLLIDER_VINDICATOR_SWING_AXE3;

	//118
	public static StaticAnimation FROM_118_DAGGER_AUTO1;
	public static StaticAnimation FROM_118_DAGGER_AUTO2;
	public static StaticAnimation FROM_118_DAGGER_AUTO3;
	public static StaticAnimation FROM_118_GREATSWORD_AUTO1;
	public static StaticAnimation FROM_118_GREATSWORD_AUTO2;
	public static StaticAnimation FROM_118_LONGSWORD_LIECHTENAUER_AUTO1;
	public static StaticAnimation FROM_118_LONGSWORD_LIECHTENAUER_AUTO2;
	public static StaticAnimation FROM_118_LONGSWORD_LIECHTENAUER_AUTO3;
	public static StaticAnimation FROM_118_SWORD_DUAL_AUTO1;
	public static StaticAnimation FROM_118_SWORD_DUAL_AUTO2;
	public static StaticAnimation FROM_118_SWORD_DUAL_AUTO3;
	public static StaticAnimation FROM_118_TACHI_AUTO1;
	public static StaticAnimation FROM_118_TACHI_AUTO2;
	public static StaticAnimation FROM_118_TACHI_AUTO3;

	public static StaticAnimation FROM_118_SPEAR_ONEHAND_AUTO;

	public static StaticAnimation FROM_118_SPEAR_TWOHAND_AUTO1;

	public static StaticAnimation FROM_118_SPEAR_TWOHAND_AUTO2;

	public static StaticAnimation FROM_118_DAGGER_DASH;

	public static StaticAnimation FROM_118_DAGGER_DUAL_AUTO1;

	public static StaticAnimation FROM_118_DAGGER_DUAL_AUTO2;

	public static StaticAnimation FROM_118_DAGGER_DUAL_AUTO3;

	public static StaticAnimation FROM_118_DAGGER_DUAL_AUTO4;

	public static StaticAnimation FROM_118_DAGGER_DUAL_DASH;

	public static StaticAnimation TEST;
	public static StaticAnimation FUCK;


	public static StaticAnimation SPEAR_GUARD_ACTION;
	public static StaticAnimation SWORD_GUARD_ACTION;
	public static StaticAnimation SWORD_DUAL_GUARD_ACTION;
	public static StaticAnimation GREATSWORD_GUARD_ACTION;
	public static StaticAnimation KATANA_GUARD_ACTION;
	public static StaticAnimation LONGSWORD_GUARD_ACTION;



	public static StaticAnimation FROM_118_BIPED_HOLD_GREATSWORD;
	public static StaticAnimation FROM_118_BIPED_HOLD_DUAL_WEAPON;
	public static StaticAnimation FROM_118_BIPED_ONE_HAND_IDLE;
	public static StaticAnimation FROM_118_BIPED_ONE_HAND_WALK;
	public static StaticAnimation FROM_118_BIPED_RUN_GREATSWORD;
	public static StaticAnimation FROM_118_BIPED_WALK_GREATSWORD;
	public static StaticAnimation FROM_118_BIPED_DRINK;
	public static StaticAnimation FROM_118_BIPED_EAT;

	public static StaticAnimation VANILLA_STEP_FORWARD;
	public static StaticAnimation VANILLA_STEP_BACKWARD;
	public static StaticAnimation VANILLA_STEP_LEFT;
	public static StaticAnimation VANILLA_STEP_RIGHT;

	public static StaticAnimation LONG_STEP_FORWARD;
	public static StaticAnimation LONG_STEP_BACKWARD;
	public static StaticAnimation LONG_STEP_LEFT;
	public static StaticAnimation LONG_STEP_RIGHT;

	public static StaticAnimation YMD_STEP_FORWARD;
	public static StaticAnimation YMD_STEP_BACKWARD;
	public static StaticAnimation YMD_STEP_LEFT;
	public static StaticAnimation YMD_STEP_RIGHT;
	//falchion author:nameless
	...
	public static StaticAnimation MENZEN_LETHAL_SLICING_START1;
	public static StaticAnimation MENZEN_LETHAL_SLICING_START2;
	public static StaticAnimation MENZEN_BOW;
	public static StaticAnimation MENZEN_PRAY;
	public static StaticAnimation MENZEN_XIAZHI;
	public static StaticAnimation MENZEN_ZENYANG;
	public static StaticAnimation MENZEN_ZMTY;
	public static StaticAnimation MENZEN_JACKO;
	public static StaticAnimation MENZEN_FIREGUN_RELOAD;
	public static StaticAnimation MENZEN_FIREGUN_RELOAD2;
	public static StaticAnimation MENZEN_CROSSBOW_RELOAD;
	public static StaticAnimation MENZEN_XBOW_RELOAD;
	public static StaticAnimation MENZEN_SHANGGOUQUAN;
	public static StaticAnimation MENZEN_AXE_SLASH;
	public static StaticAnimation MENZEN_KYBO;
	public static StaticAnimation MENZEN_KIBO_DASH;
	public static StaticAnimation MENZEN_KICK_HARD;
	public static StaticAnimation MENZEN_DIRGE_UNIQUE_SKILL;
	public static StaticAnimation MENZEN_GUANDAO_SLASH;
	public static StaticAnimation MENZEN_DAGGER_SLASH;
	public static StaticAnimation MENZEN_HORSE_IDLE;

	//tnt
	public static StaticAnimation TNT_SB;
	...
	private static void build() {
		...
		BIPED_KATANA_SCRAP = new StaticAnimation(false, "biped/living/katana_scrap", biped)
				.addProperty(StaticAnimationProperty.EVENTS, new Event[] {Event.create(0.15F, ReuseableEvents.KATANA_IN, Side.CLIENT)});
		...
		SPEAR_GUARD_ACTION = new MainFrameAnimation(0.35f, "biped/tkk/guard_spear", biped).newTimePair(0.0F, 0.4f);
		SWORD_GUARD_ACTION = new MainFrameAnimation(0.35f, "biped/tkk/guard_sword", biped).newTimePair(0.0F, 0.4f);
		SWORD_DUAL_GUARD_ACTION = new MainFrameAnimation(0.35f, "biped/tkk/guard_dualsword", biped).newTimePair(0.0F, 0.4f);
		GREATSWORD_GUARD_ACTION = new MainFrameAnimation(0.35F, "biped/tkk/guard_greatsword", biped).newTimePair(0.0F, 0.4f);
		KATANA_GUARD_ACTION = new MainFrameAnimation(0.35F, "biped/tkk/guard_katana", biped).newTimePair(0.0F, 0.4f);
		LONGSWORD_GUARD_ACTION = new MainFrameAnimation(0.35F, "biped/tkk/guard_longsword", biped).newTimePair(0.0F, 0.4f);

		SPEAR_GUARD = new StaticAnimation(0.25F,true, "biped/skill/guard_spear", biped);
		SWORD_GUARD = new StaticAnimation(0.25F,true, "biped/skill/guard_sword", biped);
		SWORD_DUAL_GUARD = new StaticAnimation(0.25F,true, "biped/skill/guard_dualsword", biped);
		...
		BIPED_STEP_FORWARD_GHOST = new DodgeAnimation(0.001F, "biped/skill/step_forward", 0.6F, 1.65F, biped);
		BIPED_STEP_BACKWARD_GHOST = new DodgeAnimation(0.05F, "biped/skill/step_backward", 0.6F, 1.65F, biped);
		BIPED_STEP_LEFT_GHOST = new DodgeAnimation(0.05F, "biped/skill/step_left", 0.6F, 1.65F, biped);
		BIPED_STEP_RIGHT_GHOST = new DodgeAnimation(0.05F, "biped/skill/step_right", 0.6F, 1.65F, biped);
		...
		FIST_AUTO3 = new BasicAttackAnimation(0.08F, 0.05F, 0.16F, 0.5F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/fist_auto3", biped)
				.addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLUNT);
		FIST_AUTO3_LONG = new BasicAttackAnimation(0.08F, 0.05F, 0.16F, 0.5F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/fist_auto3", biped)
		...
		FIST_DASH = new DashAttackAnimation(0.06F, 0.05F, 0.15F, 0.3F, 0.7F, null, "Shoulder_R", "biped/combat/fist_dash", biped)
				...
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);
		SWORD_AUTO1_DUNT = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.3F, null, "Tool_R", "biped/combat/sword_auto1", biped)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 5)
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
				.addProperty(StaticAnimationProperty.EVENTS, new Event[]{Event.create(0.0F, ReuseableEvents.STAMINA_RECOVERY, Side.SERVER)});
		...
		SWORD_AUTO3_DUNT = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.6F, null, "Tool_R", "biped/combat/sword_auto3", biped)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 15)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.0F);
		SWORD_AUTO3_PLUS = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.6F, null, "Tool_R", "biped/combat/sword_auto3", biped)
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.85F))
		...
		GREATSWORD_AUTO2_DUNT = new BasicAttackAnimation(0.2F, 0.4F, 0.6F, 0.8F, null, "Tool_R", "biped/combat/greatsword_auto2", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
		...
		GREATSWORD_AUTO3_LONGNIGHT = new BasicAttackAnimation(0.15F, 0.05F, 0.5F, 0.8F, null, "Tool_R", "biped/combat/longsword_auto3", biped)
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.5F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD);
		GREATSWORD_AUTO4_LONGNIGHT = new BasicAttackAnimation(0.08F, 0.15F, 0.26F, 0.5F, null, "Tool_R", "biped/combat/dagger_auto3", biped)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 10)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(0.05F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.LONG);
		GREATSWORD_DASH_DUNT = new DashAttackAnimation(0.11F, 0.4F, 0.65F, 0.8F, 1.2F, null, "Tool_R", "biped/combat/greatsword_dash", false, biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F))
		...
		GREATSWORD_HEAVY_CHOPPING_LONGNIGHT = new AttackAnimation(0.15F, 0.45F, 0.85F, 0.95F, 2.2F, null, "Tool_R", "biped/combat/mob_greatsword1", biped)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 10)
				.addProperty(AttackPhaseProperty.ARMOR_NEGATION, ValueCorrector.adder(30.0F))
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.65F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(2.75F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.85F)
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.KNOCKDOWN)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackAnimationProperty.ROTATE_X, true);
		GREATSWORD_HEAVY_CHOPPING = new AttackAnimation(0.15F, 0.45F, 0.85F, 0.95F, 2.2F, null, "Tool_R", "biped/combat/mob_greatsword1", biped)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 10)
		...
		SPEAR_DASH = new DashAttackAnimation(0.16F, 0.05F, 0.2F, 0.3F, 0.7F, null, "Tool_R", "biped/combat/spear_dash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		SICKLE_TWOHAND_AUTO1 = new BasicAttackAnimation(0.25F, 0.05F, 0.3F, 0.45F, null, "Tool_R", "biped/combat/spear_twohand_auto1", biped);
		SICKLE_TWOHAND_AUTO2 = new BasicAttackAnimation(0.25F, 0.05F, 0.15F, 0.42F, null, "Tool_R", "biped/combat/spear_twohand_auto2", biped);
		SICKLE_TWOHAND_AUTO3 = new DashAttackAnimation(0.11F, 0.4F, 0.5F, 0.9F, 1.2F, null, "Tool_R", "biped/combat/greatsword_dash", false, biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		SICKLE_TWOHAND_AUTO4 = new BasicAttackAnimation(0.15F, 0.05F, 0.5F, 0.8F, null, "Tool_R", "biped/combat/longsword_auto3", biped)
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.LONG);
		...
		AXE_DASH_DUNT = new DashAttackAnimation(0.25F, 0.08F, 0.4F, 0.46F, 0.9F, null, "Tool_R", "biped/combat/axe_dash", biped).addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.25F))
		...
		AXE_DASH = new DashAttackAnimation(0.25F, 0.08F, 0.4F, 0.46F, 0.9F, null, "Tool_R", "biped/combat/axe_dash", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		AXE_DASH_LINK = new DashAttackAnimation(0.25F, 0.08F, 0.4F, 0.46F, 0.9F, null, "Tool_R", "biped/combat/axe_dash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		/*
		SWORD_DUAL_AUTO1 = new BasicAttackAnimation(0.16F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/combat/sword_dual_auto1", biped);
		SWORD_DUAL_AUTO2_RAPID = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.15F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/sword_dual_auto2", biped)
				...
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 12);
		...
		SWORD_DUAL_AUTO3_RAPID = new BasicAttackAnimation(0.18F, 0.0F, 0.25F, 0.35F, 0.6F, ColliderPreset.DUAL_SWORD, "Torso", "biped/combat/sword_dual_auto3", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.25F))
		...
		SWORD_DUAL_DASH = new DashAttackAnimation(0.16F, 0.05F, 0.05F, 0.3F, 0.75F, ColliderPreset.DUAL_SWORD_DASH, "Root", "biped/combat/sword_dual_dash", biped)
				...
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		*/
		SWORD_DUAL_AUTO1 = new BasicAttackAnimation(0.31F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/combat/sword_dual_auto1", biped);
		SWORD_DUAL_AUTO2_RAPID = new BasicAttackAnimation(0.28F, 0.0F, 0.11F, 0.15F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/sword_dual_auto2", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.75F)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 12);
		SWORD_DUAL_AUTO2 = new BasicAttackAnimation(0.28F, 0.0F, 0.11F, 0.15F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/sword_dual_auto2", biped);
		SWORD_DUAL_AUTO3_RAPID = new BasicAttackAnimation(0.33F, 0.0F, 0.25F, 0.35F, 0.6F, ColliderPreset.DUAL_SWORD, "Torso", "biped/combat/sword_dual_auto3", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.2F);
		SWORD_DUAL_AUTO3 = new BasicAttackAnimation(0.33F, 0.0F, 0.25F, 0.35F, 0.6F, ColliderPreset.DUAL_SWORD, "Torso", "biped/combat/sword_dual_auto3", biped);
		SWORD_DUAL_DASH = new DashAttackAnimation(0.31F, 0.05F, 0.05F, 0.3F, 0.75F, ColliderPreset.DUAL_SWORD_DASH, "Root", "biped/combat/sword_dual_dash", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		KATANA_AUTO1 = new BasicAttackAnimation(0.06F, 0.05F, 0.16F, 0.2F, null, "Tool_R", "biped/combat/katana_auto1", biped);
		KATANA_AUTO2_DUNT = new BasicAttackAnimation(0.16F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/combat/katana_auto2", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.5F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.85F)
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD);
		...
		KATANA_AUTO3 = new BasicAttackAnimation(0.06F, 0.1F, 0.21F, 0.59F, null, "Tool_R", "biped/combat/katana_auto3", biped)
				.addProperty(StaticAnimationProperty.EVENTS, new Event[] {Event.create(1.5F, ReuseableEvents.KATANA_IN, Side.CLIENT)});
		KATANA_AUTO4 = new BasicAttackAnimation(0.16F, 0.05F, 0.16F, 0.85F, null, "Tool_R", "biped/combat/axe_auto2", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.25F));
		KATANA_DASH = new BasicAttackAnimation(0.3F, 0.05F, 0.2F, 0.55F, 0.6F, null, "Tool_R", "biped/combat/spear_dash", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
		...
		KATANA_SHEATHING_AUTO = new BasicAttackAnimation(0.06F, 0.0F, 0.06F, 0.65F, ColliderPreset.FATAL_DRAW, "Root", "biped/combat/katana_sheath_auto", biped)
				...
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(2.25F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(3.25F))
				.addProperty(AttackPhaseProperty.MAX_STRIKES, ValueCorrector.adder(10))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
		...
		KATANA_SHEATHING_DASH = new DashAttackAnimation(0.06F, 0.05F, 0.05F, 0.11F, 0.65F, null, "Tool_R", "biped/combat/katana_sheath_dash", biped)
				...
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
				.addProperty(AttackPhaseProperty.SWING_SOUND, EpicFightSounds.WHOOSH_SHARP);
		AXE_AUTO1_DUNT = new BasicAttackAnimation(0.16F, 0.05F, 0.16F, 0.7F, null, "Tool_R", "biped/combat/axe_auto1", biped)
		...
		AXE_AUTO2_DUNT = new BasicAttackAnimation(0.16F, 0.05F, 0.16F, 0.85F, null, "Tool_R", "biped/combat/axe_auto2", biped)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.5F)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F))
		...
		LONGSWORD_AUTO2_DUNT = new BasicAttackAnimation(0.15F, 0.1F, 0.21F, 0.45F, null, "Tool_R", "biped/combat/longsword_auto2", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(2.5F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
		...
		LONGSWORD_DASH = new DashAttackAnimation(0.15F, 0.1F, 0.3F, 0.5F, 0.7F, null, "Tool_R", "biped/combat/longsword_dash", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		LONGSWORD_DASH2 = new AttackAnimation(0.15F, 0.15F, 0.25F, 0.35F, 1.0F, null, "Tool_R", "biped/combat/mob_tachi_special", biped)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.5F))
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		...
		DAGGER_AUTO3_DUNT = new BasicAttackAnimation(0.08F, 0.15F, 0.26F, 0.5F, null, "Tool_R", "biped/combat/dagger_auto3", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.5F)
		...
		DAGGER_DUAL_AUTO2_RAPID = new BasicAttackAnimation(0.08F, 0.0F, 0.11F, 0.16F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/dagger_dual_auto2", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.25F)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 12);
		DAGGER_DUAL_AUTO3_DUNT = new BasicAttackAnimation(0.08F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/combat/dagger_dual_auto3", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.5F)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		DAGGER_DUAL_AUTO3 = new BasicAttackAnimation(0.08F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/combat/dagger_dual_auto3", biped);
		DAGGER_DUAL_AUTO4_HOLD = new BasicAttackAnimation(0.13F, 0.1F, 0.21F, 0.4F, Hand.OFF_HAND, ColliderPreset.DUAL_DAGGER_DASH, "Root", "biped/combat/dagger_dual_auto4", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(0.1F))
		...
		DAGGER_DUAL_DASH = new DashAttackAnimation(0.1F, 0.1F, 0.25F, 0.3F, 0.65F, ColliderPreset.DUAL_DAGGER_DASH, "Root", "biped/combat/dagger_dual_dash", biped)
				...
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		*/
		DAGGER_DUAL_AUTO2 = new BasicAttackAnimation(0.23F, 0.0F, 0.11F, 0.16F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/dagger_dual_auto2", biped);
		DAGGER_DUAL_AUTO2_RAPID = new BasicAttackAnimation(0.23F, 0.0F, 0.11F, 0.16F, Hand.OFF_HAND, null, "Tool_L", "biped/combat/dagger_dual_auto2", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.25F)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 12);
		DAGGER_DUAL_AUTO3_DUNT = new BasicAttackAnimation(0.23F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/combat/dagger_dual_auto3", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.5F)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		DAGGER_DUAL_AUTO3 = new BasicAttackAnimation(0.23F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/combat/dagger_dual_auto3", biped);
		DAGGER_DUAL_AUTO4_HOLD = new BasicAttackAnimation(0.28F, 0.1F, 0.21F, 0.4F, Hand.OFF_HAND, ColliderPreset.DUAL_DAGGER_DASH, "Root", "biped/combat/dagger_dual_auto4", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(0.1F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.95F)
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.LONG);
		DAGGER_DUAL_AUTO4 = new BasicAttackAnimation(0.28F, 0.1F, 0.21F, 0.4F, ColliderPreset.DUAL_DAGGER_DASH, "Root", "biped/combat/dagger_dual_auto4", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F));
		DAGGER_DUAL_DASH = new DashAttackAnimation(-0.05F, 0.1F, 0.25F, 0.3F, 0.65F, ColliderPreset.DUAL_DAGGER_DASH, "Root", "biped/combat/dagger_dual_dash", biped)
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.1F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 2.4F)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		SWORD_AIR_SLASH = new AirSlashAnimation(0.1F, 0.15F, 0.26F, 0.5F, null, "Tool_R", "biped/combat/sword_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		SWORD_AIR_SLASH_CONTINUOUS_CUTTING = new AirSlashAnimation(0.1F, 0.15F, 0.26F, 0.5F, null, "Tool_R", "biped/combat/sword_airslash", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.33F))
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.75F);
		SWORD_AIR_SLASH_HEAVY_CHOPPING = new AirSlashAnimation(0.1F, 0.15F, 0.26F, 0.5F, null, "Tool_R", "biped/combat/sword_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.5F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(0.5F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.LONG)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.0F);
		SWORD_DUAL_AIR_SLASH_DUNT = new AirSlashAnimation(0.1F, 0.15F, 0.26F, 0.5F, ColliderPreset.DUAL_SWORD_AIR_SLASH, "Torso", "biped/combat/sword_dual_airslash", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.25F))
		...
		KATANA_SHEATH_AIR_SLASH = new AirSlashAnimation(0.1F, 0.1F, 0.16F, 0.3F, null, "Tool_R", "biped/combat/katana_sheath_airslash", biped)
				...
				.addProperty(AttackPhaseProperty.ARMOR_NEGATION, ValueCorrector.adder(30.0F))
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(2.0F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(3.6F))
				...
				.addProperty(StaticAnimationProperty.EVENTS, new Event[]{Event.create(0.1F, ReuseableEvents.STAMINA_RECOVERY, Side.SERVER)});
		SPEAR_TWOHAND_AIR_SLASH_DUNT = new AirSlashAnimation(0.1F, 0.25F, 0.36F, 0.6F, null, "Tool_R", "biped/combat/spear_twohand_airslash", biped)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.1F)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		SPEAR_ONEHAND_AIR_SLASH = new AirSlashAnimation(0.3F, 0.15F, 0.26F, 0.4F, null, "Tool_R", "biped/combat/spear_onehand_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		...
		LONGSWORD_AIR_SLASH = new AirSlashAnimation(0.1F, 0.3F, 0.41F, 0.5F, null, "Tool_R", "biped/combat/longsword_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		LONGSWORD_AIR_SLASH_DUNT = new AirSlashAnimation(0.1F, 0.3F, 0.41F, 0.5F, null, "Tool_R", "biped/combat/longsword_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.5F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(0.25F))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.LONG)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.0F);
		LONGSWORD_AIR_SLASH_JUMP = new AirSlashAnimation(0.1F, 0.3F, 0.41F, 0.5F, null, "Tool_R", "biped/combat/longsword_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true)
		...
		GREATSWORD_AIR_SLASH = new AirSlashAnimation(0.1F, 0.5F, 0.55F, 0.71F, 0.75F, false, null, "Tool_R", "biped/combat/greatsword_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		GREATSWORD_AIR_SLASH2 = new AirSlashAnimation(0.1F, 0.3F, 0.41F, 0.5F, null, "Tool_R", "biped/combat/longsword_airslash", biped)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.5F)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		GREATSWORD_AIR_SLASH_LONGNIGHT = new AirSlashAnimation(0.1F, 0.5F, 0.55F, 0.71F, 0.75F, false, null, "Tool_R", "biped/combat/greatsword_airslash", biped)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 10)
				.addProperty(AttackPhaseProperty.ARMOR_NEGATION, ValueCorrector.adder(30.0F))
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.85F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.25F))
				.addProperty(AttackPhaseProperty.FINISHER, true);
		...
		FIST_AIR_SLASH_KNOCKDOWN = new AirSlashAnimation(0.1F, 0.15F, 0.26F, 0.4F, null, "Tool_R", "biped/combat/fist_airslash", biped)
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.KNOCKDOWN)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 4.0F);
		...
		BIPED_MOB_SWORD_DUAL2 = new AttackAnimation(0.1F, "biped/combat/mob_sword_dual2", biped,
				...
				.addProperty(AttackAnimationProperty.ROTATE_X, true);
		BIPED_MOB_SWORD_DUAL3_DUALAXE = new AttackAnimation(0.1F, 0.25F, 0.85F, 0.95F, 1.4F,ColliderPreset.DUAL_SWORD_AIR_SLASH , "Torso", "biped/combat/mob_sword_dual3", biped)
				.addProperty(ActionAnimationProperty.MOVE_VERTICAL, true);
		...
		ENDERMAN_TP_KICK2 = new AttackAnimation(0.16F, 0.15F, 0.25F, 0.45F, 1.0F, ColliderPreset.ENDERMAN_LIMB, "Leg_R", "enderman/tp_kick2", enderman)
				.addProperty(AttackAnimationProperty.ATTACK_SPEED_FACTOR, 0.0F).addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 2.8f);
		...
		SWEEPING_EDGE_CORRECT = new SpecialAttackAnimation(0.16F, 0.1F, 0.35F, 0.46F, 0.79F, null, "Tool_R", "biped/skill/sweeping_edge", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackAnimationProperty.FIXED_MOVE_DISTANCE, true)
				.addProperty(AttackAnimationProperty.ROTATE_X, true)
		...
		SPEAR_THRUST = new SpecialAttackAnimation(0.11F, "biped/skill/spear_thrust", biped,
				new Phase(0.0F, 0.15F, 0.2F, 0.35F, 0.4F, 0.4F, "Tool_R", null), new Phase(0.4F, 0.4F, 0.45F, 0.6F, 0.75F, 0.75F, "Tool_R", null),
		...
		FATAL_DRAW_NEW = new SpecialAttackAnimation(0.15F, 0.0F, 0.1F, 0.16F, 0.65F, ColliderPreset.BLADE_RUSH, "Root", "biped/skill/blade_rush_finisher", biped)
				.addProperty(AttackAnimationProperty.FIXED_MOVE_DISTANCE, true)
				...
				.addProperty(AttackPhaseProperty.EXTRA_DAMAGE, ExtraDamageType.get(ExtraDamageType.PERCENT_OF_TARGET_LOST_HEALTH, 0.075F))
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
		...
		FATAL_DRAW_DASH = new SpecialAttackAnimation(0.15F, 0.43F, 0.85F, 0.851F, 1.4F, ColliderPreset.FATAL_DRAW_DASH, "Root", "biped/skill/fatal_draw_dash", biped)
				.addProperty(AttackPhaseProperty.SWING_SOUND, EpicFightSounds.WHOOSH_SHARP)
				.addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.BLADE_RUSH_SKILL)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(2.15F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(3.65F))
				.addProperty(AttackPhaseProperty.ARMOR_NEGATION, ValueCorrector.adder(50.0F))
				.addProperty(AttackPhaseProperty.MAX_STRIKES, ValueCorrector.adder(21))
				.addProperty(AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackAnimationProperty.FIXED_MOVE_DISTANCE, true)
		...
		BLADE_RUSH_SWEEP_AWAY = new SpecialAttackAnimation(0.08F, 0.15F, 0.15F, 0.8F, 0.3F, null, "Tool_R", "biped/skill/blade_rush_first", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(1.0F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 2.8F)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 10)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 0.75F);

		//tkk
		VANILLA_DAGGER_AUTO1 = new BasicAttackAnimation(0.08F, 0.05F, 0.15F, 0.2F, null, "Tool_R", "biped/tkk/vanilla_dagger_auto1", biped);
		VANILLA_DAGGER_AUTO2 = new BasicAttackAnimation(0.08F, 0.0F, 0.1F, 0.2F, null, "Tool_R", "biped/tkk/vanilla_dagger_auto2", biped);
		VANILLA_DAGGER_AUTO3 = new BasicAttackAnimation(0.08F, 0.15F, 0.26F, 0.5F, null, "Tool_R", "biped/tkk/vanilla_dagger_auto3", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F));
		VANILLA_SWORD_DASH1 = new DashAttackAnimation(0.12F, 0.1F, 0.25F, 0.4F, 0.65F, null, "Tool_R", "biped/tkk/vanilla_sword_dash", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.1F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		VANILLA_LETHAL_SLICING_START1 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/tkk/vanilla_lethal_slicing_start1", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);;
		VANILLA_LETHAL_SLICING_START2 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/tkk/vanilla_lethal_slicing_start2", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);;
		VANILLA_LETHAL_SLICING_START3 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/tkk/vanilla_lethal_slicing_start3", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);;
		VANILLA_LETHAL_SLICING_START4 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/tkk/vanilla_lethal_slicing_start4", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);
		VANILLA_LETHAL_SLICING_START5 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/tkk/vanilla_lethal_slicing_start5", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);
		VANILLA_LETHAL_SLICING_START6 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/tkk/vanilla_lethal_slicing_start6", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);
		LION_CLAW = new SpecialAttackAnimation(0.05F, 1.54F, 1.55F, 1.6F, 3F, null, "Tool_R", "biped/skill/lion_claw", biped)
				.addProperty(AttackPhaseProperty.HIT_PRIORITY, Priority.TARGET)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);
		VANILLA_LONGSWORD_AUTO1 = new BasicAttackAnimation(0.1F, 0.2F, 0.3F, 0.45F, null, "Tool_R", "biped/vanilla/combat/longsword_auto1", biped);
		VANILLA_LONGSWORD_AUTO2 = new BasicAttackAnimation(0.15F, 0.1F, 0.21F, 0.45F, null, "Tool_R", "biped/vanilla/combat/longsword_auto2", biped);
		VANILLA_LONGSWORD_AUTO3 = new BasicAttackAnimation(0.15F, 0.05F, 0.16F, 0.8F, null, "Tool_R", "biped/vanilla/combat/longsword_auto3", biped);
		VANILLA_LONGSWORD_DASH = new DashAttackAnimation(0.15F, 0.1F, 0.3F, 0.5F, 0.7F, null, "Tool_R", "biped/vanilla/combat/longsword_dash", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		VANILLA_SWORD_AUTO1 = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.3F, null, "Tool_R", "biped/vanilla/combat/sword_auto1", biped);
		VANILLA_SWORD_AUTO2 = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.3F, null, "Tool_R", "biped/vanilla/combat/sword_auto2", biped);
		VANILLA_SWORD_AUTO3 = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.6F, null, "Tool_R", "biped/vanilla/combat/sword_auto3", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F));
		VANILLA_AXE_DASH = new DashAttackAnimation(0.25F, 0.08F, 0.4F, 0.46F, 0.9F, null, "Tool_R", "biped/vanilla/combat/axe_dash", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		VANILLA_GREATSWORD_DASH = new DashAttackAnimation(0.11F, 0.4F, 0.65F, 0.8F, 1.2F, null, "Tool_R", "biped/vanilla/combat/greatsword_dash", false, biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		VANILLA_TACHI_DASH = new DashAttackAnimation(0.15F, 0.1F, 0.2F, 0.45F, 0.7F, null, "Tool_R", "biped/vanilla/combat/tachi_dash", false, biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);

		VANILLA_SWORD_DUAL_AUTO1 = new BasicAttackAnimation(0.16F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/vanilla/combat/sword_dual_auto1", biped);
		VANILLA_SWORD_DUAL_AUTO2 = new BasicAttackAnimation(0.13F, 0.0F, 0.11F, 0.15F, Hand.OFF_HAND, null, "Tool_L", "biped/vanilla/combat/sword_dual_auto2", biped);
		VANILLA_SWORD_DUAL_AUTO3 = new BasicAttackAnimation(0.18F, 0.0F, 0.25F, 0.35F, 0.6F, ColliderPreset.DUAL_SWORD, "Torso", "biped/vanilla/combat/sword_dual_auto3", biped);
		VANILLA_SWORD_DUAL_DASH = new DashAttackAnimation(0.16F, 0.05F, 0.05F, 0.3F, 0.75F, ColliderPreset.DUAL_SWORD_DASH, "Root", "biped/vanilla/combat/sword_dual_dash", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(0.75F))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		VANILLA_SWORD_DUAL_AIR_SLASH = new AirSlashAnimation(0.1F, 0.15F, 0.26F, 0.5F, ColliderPreset.DUAL_SWORD_AIR_SLASH, "Torso", "biped/vanilla/combat/sword_dual_airslash", biped);
		VANILLA_DAGGER_DUAL_AUTO1 = new BasicAttackAnimation(0.08F, 0.05F, 0.16F, 0.25F, null, "Tool_R", "biped/vanilla/combat/dagger_dual_auto1", biped);
		VANILLA_DAGGER_DUAL_AUTO2 = new BasicAttackAnimation(0.08F, 0.0F, 0.11F, 0.16F, Hand.OFF_HAND, null, "Tool_L", "biped/vanilla/combat/dagger_dual_auto2", biped);
		VANILLA_DAGGER_DUAL_AUTO3 = new BasicAttackAnimation(0.08F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/vanilla/combat/dagger_dual_auto3", biped);
		VANILLA_DAGGER_DUAL_AUTO4 = new BasicAttackAnimation(0.13F, 0.1F, 0.21F, 0.4F, ColliderPreset.DUAL_DAGGER_DASH, "Root", "biped/vanilla/combat/dagger_dual_auto4", biped)
				.addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F));
		VANILLA_GREATSWORD_AIR_SLASH = new AirSlashAnimation(0.1F, 0.5F, 0.55F, 0.71F, 0.75F, false, null, "Tool_R", "biped/vanilla/combat/greatsword_airslash", biped)
				.addProperty(AttackPhaseProperty.FINISHER, true);
		VANILLA_KATANA_AUTO1 = new BasicAttackAnimation(0.06F, 0.05F, 0.16F, 0.2F, null, "Tool_R", "biped/vanilla/combat/katana_auto1", biped);
		VANILLA_KATANA_AUTO2 = new BasicAttackAnimation(0.16F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/vanilla/combat/katana_auto2", biped);
		VANILLA_KATANA_AUTO3 = new BasicAttackAnimation(0.06F, 0.1F, 0.21F, 0.59F, null, "Tool_R", "biped/vanilla/combat/katana_auto3", biped)
				.addProperty(StaticAnimationProperty.EVENTS, new Event[] {Event.create(1.5F, ReuseableEvents.KATANA_IN, Side.CLIENT)});
		VANILLA_SWEEPING_EDGE = new SpecialAttackAnimation(0.16F, 0.1F, 0.35F, 0.46F, 0.79F, null, "Tool_R", "biped/vanilla/skill/sweeping_edge", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackAnimationProperty.FIXED_MOVE_DISTANCE, true)
				.addProperty(AttackAnimationProperty.ROTATE_X, true)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
				.addProperty(AttackAnimationProperty.COLLIDER_ADDER, 5);
		VANILLA_DANCING_EDGE = new SpecialAttackAnimation(0.25F, "biped/vanilla/skill/dancing_edge", biped,
				new Phase(0.0F, 0.2F, 0.31F, 0.4F, 0.4F, "Tool_R", null), new Phase(0.4F, 0.5F, 0.61F, 0.65F, 0.65F, Hand.OFF_HAND, "Tool_L", null),
				new Phase(0.65F, 0.75F, 0.85F, 1.15F, Float.MAX_VALUE, "Tool_R", null))
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
				.addProperty(ActionAnimationProperty.MOVE_VERTICAL, true);
		VANILLA_SPEAR_SLASH = new SpecialAttackAnimation(0.1F, "biped/vanilla/skill/spear_slash", biped,
				new Phase(0.0F, 0.2F, 0.41F, 0.5F, 0.5F, "Tool_R", null), new Phase(0.5F, 0.5F, 0.75F, 0.95F, 1.25F, Float.MAX_VALUE, "Tool_R", null))
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackAnimationProperty.ROTATE_X, true)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.2F);
		VANILLA_GREATSWORD_AUTO1 = (StaticAnimation)new BasicAttackAnimation(0.2F, 0.4F, 0.6F, 0.8F, null, "Tool_R", "biped/vanilla/combat/greatsword_auto1", (Model)biped);
		VANILLA_GREATSWORD_AUTO2 = (StaticAnimation)new BasicAttackAnimation(0.2F, 0.4F, 0.6F, 0.8F, null, "Tool_R", "biped/vanilla/combat/greatsword_auto2", (Model)biped);
		VANILLA_SPEAR_ONEHAND_AUTO = (StaticAnimation)new BasicAttackAnimation(0.16F, 0.1F, 0.2F, 0.45F, null, "Tool_R", "biped/vanilla/combat/spear_onehand_auto", (Model)biped);
		VANILLA_SPEAR_TWOHAND_AUTO1 = (StaticAnimation)new BasicAttackAnimation(0.25F, 0.05F, 0.15F, 0.45F, null, "Tool_R", "biped/vanilla/combat/spear_twohand_auto1", (Model)biped);
		VANILLA_SPEAR_TWOHAND_AUTO2 = (StaticAnimation)new BasicAttackAnimation(0.25F, 0.05F, 0.15F, 0.45F, null, "Tool_R", "biped/vanilla/combat/spear_twohand_auto2", (Model)biped);

		VANILLA_STEP_FORWARD = new DodgeAnimation(0.05F, "biped/moredodge/vanilla/step_forward", 0.6F, 1.65F, biped);
		VANILLA_STEP_BACKWARD = new DodgeAnimation(0.05F, "biped/moredodge/vanilla/step_backward", 0.6F, 1.65F, biped);
		VANILLA_STEP_LEFT = new DodgeAnimation(0.05F, "biped/moredodge/vanilla/step_left", 0.6F, 1.65F, biped);
		VANILLA_STEP_RIGHT = new DodgeAnimation(0.05F, "biped/moredodge/vanilla/step_right", 0.6F, 1.65F, biped);

		LONG_STEP_FORWARD = new DodgeAnimation(0.05F, "biped/moredodge/long/step_forward", 0.6F, 1.65F, biped);
		LONG_STEP_BACKWARD = new DodgeAnimation(0.05F, "biped/moredodge/long/step_backward", 0.6F, 1.65F, biped);
		LONG_STEP_LEFT = new DodgeAnimation(0.05F, "biped/moredodge/long/step_left", 0.6F, 1.65F, biped);
		LONG_STEP_RIGHT = new DodgeAnimation(0.05F, "biped/moredodge/long/step_right", 0.6F, 1.65F, biped);

		YMD_STEP_FORWARD = new DodgeAnimation(0.05F, "biped/moredodge/ymd/step_forward", 0.6F, 1.65F, biped);
		YMD_STEP_BACKWARD = new DodgeAnimation(0.05F, "biped/moredodge/ymd/step_backward", 0.6F, 1.65F, biped);
		YMD_STEP_LEFT = new DodgeAnimation(0.05F, "biped/moredodge/ymd/step_left", 0.6F, 1.65F, biped);
		YMD_STEP_RIGHT = new DodgeAnimation(0.05F, "biped/moredodge/ymd/step_right", 0.6F, 1.65F, biped);



		FREE_COLLIDER_WITHER_SKELETON_ATTACK1 = new AttackAnimation(0.16F, 0.2F, 0.3F, 0.41F, 0.7F, null, "Tool_R", "wither_skeleton/sword_attack1", biped)
				.addProperty(AttackAnimationProperty.ROTATE_X, true);
		FREE_COLLIDER_WITHER_SKELETON_ATTACK2 = new AttackAnimation(0.16F, 0.25F, 0.25F, 0.36F, 0.7F, null, "Tool_R", "wither_skeleton/sword_attack2", biped)
				.addProperty(AttackAnimationProperty.ROTATE_X, true);
		FREE_COLLIDER_WITHER_SKELETON_ATTACK3 = new AttackAnimation(0.16F, 0.25F, 0.25F, 0.36F, 0.7F, null, "Tool_R", "wither_skeleton/sword_attack3", biped)
				.addProperty(AttackAnimationProperty.ROTATE_X, true);

		FREE_COLLIDER_VINDICATOR_SWING_AXE1 = new AttackAnimation(0.2F, 0.25F, 0.35F, 0.46F, 0.71F, null, "Tool_R", "illager/swing_axe1", biped);
		FREE_COLLIDER_VINDICATOR_SWING_AXE2 = new AttackAnimation(0.2F, 0.25F, 0.3F, 0.41F, 0.71F, null, "Tool_R", "illager/swing_axe2", biped);
		FREE_COLLIDER_VINDICATOR_SWING_AXE3 = new AttackAnimation(0.05F, 0.50F, 0.62F, 0.75F, 1F, null, "Tool_R", "illager/swing_axe3", biped)
				.addProperty(ActionAnimationProperty.MOVE_VERTICAL, true);

		FROM_118_DAGGER_AUTO1 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.05F, 0.15F, 0.25F, null, "Tool_R", "biped/118/combat/dagger_auto1", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F));

		FROM_118_DAGGER_AUTO2 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.0F, 0.1F, 0.25F, null, "Tool_R", "biped/118/combat/dagger_auto2", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F));
		FROM_118_DAGGER_AUTO3 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.2F, 0.25F, 0.4F, null, "Tool_R", "biped/118/combat/dagger_auto3", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F));

		FROM_118_GREATSWORD_AUTO1 = (StaticAnimation)(new BasicAttackAnimation(0.25F, 0.15F, 0.25F, 0.65F, null, "Tool_R", "biped/118/combat/greatsword_auto1", biped))

				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.0F));
		FROM_118_GREATSWORD_AUTO2 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.5F, 0.65F, 1.5F, null, "Tool_R", "biped/118/combat/greatsword_auto2", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.0F));

		FROM_118_LONGSWORD_LIECHTENAUER_AUTO1 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.15F, 0.25F, 0.5F, null, "Tool_R", "biped/118/combat/longsword_liechtenauer_auto1", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_LONGSWORD_LIECHTENAUER_AUTO2 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.2F, 0.3F, 0.5F, null, "Tool_R", "biped/118/combat/longsword_liechtenauer_auto2", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_LONGSWORD_LIECHTENAUER_AUTO3 = (StaticAnimation)(new BasicAttackAnimation(0.25F, 0.1F, 0.2F, 0.7F, null, "Tool_R", "biped/118/combat/longsword_liechtenauer_auto3", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_SWORD_DUAL_AUTO1 = (new BasicAttackAnimation(0.08F, 0.1F, 0.2F, 0.3F, null, "Tool_R", "biped/118/combat/sword_dual_auto1", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.6F));
		FROM_118_SWORD_DUAL_AUTO2 = (new BasicAttackAnimation(0.1F, 0.1F, 0.2F, 0.3F, null, "Tool_L", "biped/118/combat/sword_dual_auto2", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.6F));
		//new AttackAnimation.Phase[] { new AttackAnimation.Phase(0.0F, 0.25F, 0.25F, 0.35F, 0.6F, Float.MAX_VALUE, false, MAIN_HAND, List.of(Pair.of(biped.toolR, null), Pair.of(biped.toolL, null))) }
		//FROM_118_SWORD_DUAL_AUTO3 = (StaticAnimation)(new BasicAttackAnimation(0.1F, "biped/118/combat/sword_dual_auto3", biped, ))
		FROM_118_SWORD_DUAL_AUTO3 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.25F, 0.25F, 0.35F, 0.6F, null, "Torso", "biped/118/combat/sword_dual_auto3", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.6F));
		FROM_118_TACHI_AUTO1 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.35F, 0.4F, 0.5F, null, "Tool_R", "biped/118/combat/tachi_auto1", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_TACHI_AUTO2 = (StaticAnimation)(new BasicAttackAnimation(0.15F, 0.2F, 0.3F, 0.5F, null, "Tool_R", "biped/118/combat/tachi_auto2", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_TACHI_AUTO3 = (StaticAnimation)(new BasicAttackAnimation(0.15F, 0.2F, 0.3F, 0.85F, null, "Tool_R", "biped/118/combat/tachi_auto3", biped))
				.addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));



		FROM_118_BIPED_HOLD_GREATSWORD = new StaticAnimation(true, "biped/118/idle/hold_greatsword", biped);
		FROM_118_BIPED_HOLD_DUAL_WEAPON = new StaticAnimation(true, "biped/118/idle/hold_dual", biped);
		FROM_118_BIPED_ONE_HAND_IDLE = new StaticAnimation(true, "biped/118/idle/one_hand_idle", biped);
		FROM_118_BIPED_ONE_HAND_WALK = (StaticAnimation)new MovementAnimation(true, "biped/118/idle/one_hand_walk", biped);
		FROM_118_BIPED_RUN_GREATSWORD = (StaticAnimation)new MovementAnimation(true, "biped/118/idle/run_greatsword", biped);
		FROM_118_BIPED_WALK_GREATSWORD = (StaticAnimation)new MovementAnimation(true, "biped/118/idle/walk_greatsword", biped);


		FALCHION_IDLE = new StaticAnimation(true, "biped/nameless/falchion/falchion_idle", biped);
		FALCHION_AUTO1 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.25F, 0.317F, 0.5F, null, "Tool_R", "biped/nameless/falchion/falchion_auto1", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F)).addProperty(AnimationProperty.AttackAnimationProperty.ATTACK_SPEED_FACTOR, Float.valueOf(0.5F));
		FALCHION_AUTO2 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.167F, 0.233F, 0.5F, null, "Tool_R", "biped/nameless/falchion/falchion_auto2", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F)).addProperty(AnimationProperty.AttackAnimationProperty.ATTACK_SPEED_FACTOR, Float.valueOf(0.5F));
		FALCHION_AUTO3 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.333F, 0.383F, 0.95F, null, "Tool_R", "biped/nameless/falchion/falchion_auto3", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F)).addProperty(AnimationProperty.AttackAnimationProperty.ATTACK_SPEED_FACTOR, Float.valueOf(0.5F));
		FALCHION_FORWARD = (StaticAnimation)(new SpecialAttackAnimation(0.0F, "biped/nameless/falchion/falchion_forward", biped, new AttackAnimation.Phase[] { new AttackAnimation.Phase(0.0F, 0.6F, 0.667F, 0.75F, 0.75F, "Tool_R", null), (new AttackAnimation.Phase(0.75F, 0.85F, 0.9F, 1.35F, Float.MAX_VALUE, "Tool_R", null)).addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, ExtendedDamageSource.StunType.LONG).addProperty(AnimationProperty.AttackPhaseProperty.IMPACT, ValueCorrector.setter(4.0F)).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F)) })).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(0.95F)).addProperty(AnimationProperty.AttackAnimationProperty.ATTACK_SPEED_FACTOR, Float.valueOf(0.5F)).addProperty(AnimationProperty.ActionAnimationProperty.MOVE_VERTICAL, Boolean.valueOf(true));
		FALCHION_BACKWARD = (StaticAnimation)(new SpecialAttackAnimation(0.0F, "biped/nameless/falchion/falchion_backward", biped, new AttackAnimation.Phase[] { (new AttackAnimation.Phase(0.0F, 0.5F, 0.6F, 1.0F, 1.0F, "Tool_R", null)).addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, ExtendedDamageSource.StunType.HOLD).addProperty(AnimationProperty.AttackPhaseProperty.IMPACT, ValueCorrector.setter(5.0F)), (new AttackAnimation.Phase(1.0F, 1.63F, 1.7F, 2.33F, Float.MAX_VALUE, "Tool_R", null)).addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, ExtendedDamageSource.StunType.KNOCKDOWN).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.25F)) })).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(0.85F)).addProperty(AnimationProperty.AttackAnimationProperty.ATTACK_SPEED_FACTOR, Float.valueOf(0.5F)).addProperty(AnimationProperty.AttackAnimationProperty.FIXED_MOVE_DISTANCE, Boolean.valueOf(true)).addProperty(AnimationProperty.ActionAnimationProperty.MOVE_VERTICAL, Boolean.valueOf(true));
		FALCHION_SIDE = (StaticAnimation)(new SpecialAttackAnimation(0.1F, 0.25F, 0.58F, 0.667F, 1.0F, null, "Tool_R", "biped/nameless/falchion/falchion_side", biped)).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(2.0F)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.0F)).addProperty(AnimationProperty.AttackAnimationProperty.ATTACK_SPEED_FACTOR, Float.valueOf(0.5F));

		FROM_118_SPEAR_ONEHAND_AUTO = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.35F, 0.45F, 0.75F, null, "Tool_R", "biped/118/combat/spear_onehand_auto", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_SPEAR_TWOHAND_AUTO1 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.2F, 0.3F, 0.45F, null, "Tool_R", "biped/118/combat/spear_twohand_auto1", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_SPEAR_TWOHAND_AUTO2 = (StaticAnimation)(new BasicAttackAnimation(0.1F, 0.2F, 0.3F, 0.7F, null, "Tool_R", "biped/118/combat/spear_twohand_auto2", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(1.2F));
		FROM_118_DAGGER_DASH = (new DashAttackAnimation(0.05F, 0.1F, 0.2F, 0.25F, 0.6F, null, "Tool_R", "biped/118/combat/dagger_dash", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F));
		FROM_118_DAGGER_DUAL_AUTO1 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.1F, 0.2F, 0.25F, null, "Tool_R", "biped/118/combat/dagger_dual_auto1", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F));
		FROM_118_DAGGER_DUAL_AUTO2 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.0F, 0.11F, 0.16F, null, "Tool_L", "biped/118/combat/dagger_dual_auto2", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F));
		FROM_118_DAGGER_DUAL_AUTO3 = (StaticAnimation)(new BasicAttackAnimation(0.05F, 0.0F, 0.11F, 0.2F, null, "Tool_R", "biped/118/combat/dagger_dual_auto3", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F));
		FROM_118_DAGGER_DUAL_AUTO4 = (StaticAnimation)(new BasicAttackAnimation(0.15F,0.1f,0.2f,0.2f,null,"Torso", "biped/118/combat/dagger_dual_auto4", biped).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F)));
		FROM_118_DAGGER_DUAL_DASH = (StaticAnimation)(new DashAttackAnimation(0.1F, 0.1F, 0.25F, 0.3F, 0.65F, ColliderPreset.DUAL_DAGGER_DASH, "Torso", "biped/118/combat/dagger_dual_dash", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, Float.valueOf(2.4F)).addProperty(AnimationProperty.ActionAnimationProperty.MOVE_VERTICAL, Boolean.valueOf(true));
		FROM_118_BIPED_DRINK = (StaticAnimation)new MirrorAnimation(0.35F, true, "biped/118/living/drink", "biped/118/living/drink_offhand", biped);
		FROM_118_BIPED_EAT = (StaticAnimation)new MirrorAnimation(0.35F, true, "biped/118/living/eat", "biped/118/living/eat_offhand", biped);

		TEST = new StaticAnimation(true, "biped/tkk/test", biped);
		MENZEN_LETHAL_SLICING_START1 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/menzen/lethal_slicing_start", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);
		MENZEN_LETHAL_SLICING_START2 = new SpecialAttackAnimation(0.15F, 0.0F, 0.0F, 0.11F, 0.38F, ColliderPreset.FIST_FIXED, "Root", "biped/menzen/lethal_slicing_start111", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(StaticAnimationProperty.PLAY_SPEED, 1.0F);
		FUCK = new BasicAttackAnimation(0.05F, 0.0F, 0.05F, 0.1F, 0.116F, ColliderPreset.DUAL_SWORD, "Torso", "biped/combat/fuck", biped);

		MENZEN_BOW = new StaticAnimation(true, "biped/menzen/bow", biped);
		MENZEN_PRAY = new StaticAnimation(true, "biped/menzen/pray", biped);
		MENZEN_XIAZHI = new StaticAnimation(true, "biped/menzen/xiazhi", biped);
		MENZEN_ZENYANG = new StaticAnimation(true, "biped/menzen/zenyang", biped);
		MENZEN_ZMTY = new StaticAnimation(true, "biped/menzen/zmty", biped);
		MENZEN_JACKO = new StaticAnimation(true, "biped/menzen/jacko", biped);
		MENZEN_AXE_SLASH = new BasicAttackAnimation(0.0F, 0.396F, 0.73F, 1.357F, null, "Tool_R", "biped/menzen/axe_slash", biped);
		MENZEN_SHANGGOUQUAN = new BasicAttackAnimation(0.0f, 0.495F, 0.592F, 0.891F, Hand.OFF_HAND,null, "Tool_L", "biped/menzen/shanggouquan", biped)
				.addProperty(AttackAnimationProperty.ATTACK_SPEED_FACTOR, 0.5F).addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.0f).addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLUNT);
		MENZEN_KYBO = new LongHitAnimation(0.05F, "biped/menzen/kybo", biped);
		MENZEN_FIREGUN_RELOAD = new StaticAnimation(false, "biped/menzen/firegun_reloading", biped);
		MENZEN_FIREGUN_RELOAD2 = new StaticAnimation(false, "biped/menzen/firegun_reloading2", biped);
		MENZEN_CROSSBOW_RELOAD = new StaticAnimation(false, "biped/menzen/nu_reloading", biped);
		MENZEN_XBOW_RELOAD = new StaticAnimation(false, "biped/menzen/xxxnu_reloading", biped);
		MENZEN_KIBO_DASH = new DashAttackAnimation(0.0F, 0.0F, 0.462F, 0.99F, 1.485F, null, "Tool_R", "biped/menzen/kibo_dash", biped)
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true);
		MENZEN_KICK_HARD = new BasicAttackAnimation(0.0F, 0.5F, 0.76F, 1.27F, ColliderPreset.ENDERMAN_LIMB, "Leg_R", "biped/menzen/kick_hard", biped);
		MENZEN_DIRGE_UNIQUE_SKILL = new BasicAttackAnimation(0.0F, 5.0F, 5.0F, 5F, null, "Tool_R", "biped/menzen/dirge_unique_skill", biped)
				.addProperty(ActionAnimationProperty.MOVE_VERTICAL, true);
		MENZEN_GUANDAO_SLASH = new SpecialAttackAnimation(0.1F, "biped/menzen/guandao_slash", biped,
				new Phase(0.0F, 0.43F, 0.6F, 0.6F, 0.6F, "Tool_R", null), new Phase(0.6F, 1.03F,  1.36F, 1.66F, Float.MAX_VALUE, "Tool_R", null))
				.addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
				.addProperty(AttackPhaseProperty.FINISHER, true)
				.addProperty(AttackAnimationProperty.ROTATE_X, true)
				.addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.2F);
		MENZEN_DAGGER_SLASH = new BasicAttackAnimation(0.0F, 0.575F, 0.725F, 1.212F, null, "Tool_R", "biped/menzen/dagger_slash", biped);
		MENZEN_HORSE_IDLE = (new StaticAnimation(true,"biped/menzen/horse_idle",biped));
		TNT_SB = new SpecialAttackAnimation(0.0F, "biped/tnt/sb_animation", biped,
				new Phase(0.0F, 0.3F, 0.43F, 0.43F, 0.43F, "Elbow_L", ColliderPreset.FIST), new Phase(0.43F, 0.73F,  1.0F, 1.33F, Float.MAX_VALUE, "Tool_R", null));
		WOMAnimations.build();
	}

	public static class ReuseableEvents {
		public static final Consumer<LivingEntityPatch<?>> WING_FLAP = (entitypatch) -> {
			if (entitypatch instanceof EnderDragonPatch) {
		...
		public static final Consumer<LivingEntityPatch<?>> STAMINA_RECOVERY = (entitypatch) -> {
			float stamina = ((PlayerPatch<?>) entitypatch) .getStamina();
			float maxstamina = ((PlayerPatch<?>) entitypatch) .getMaxStamina();
			if(stamina < maxstamina){
				((PlayerPatch<?>) entitypatch).setStamina(stamina+(float)0.2*maxstamina);
			}
	    };
		public static final Consumer<LivingEntityPatch<?>> STAMINA_RECOVERY_GHOST = (entitypatch) -> {
			float stamina = ((PlayerPatch<?>) entitypatch) .getStamina();
			float maxstamina = ((PlayerPatch<?>) entitypatch) .getMaxStamina();
			if(stamina < maxstamina){
				((PlayerPatch<?>) entitypatch).setStamina(stamina-(float)0.09*maxstamina);
			}
		};
		public static final Consumer<LivingEntityPatch<?>> KATANA_IN = (entitypatch) -> entitypatch.playSound(EpicFightSounds.SWORD_IN, 0, 0);
	}
