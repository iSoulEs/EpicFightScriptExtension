...
public class EpicFightSounds {
	...
	//yamatomoveset\sounds\sfx\foresight.ogg
	public static final SoundEvent SKILL_TECHNICIAN = registerSound("skill.technician");
	public static final SoundEvent SKILL_ROLL = registerSound("skill.roll");
	public static final SoundEvent SKILL_STEP = registerSound("skill.step");
