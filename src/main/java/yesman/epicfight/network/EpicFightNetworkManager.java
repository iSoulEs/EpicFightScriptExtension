...
import tkk.epic.network.SPTkkCustomData;
...
public class EpicFightNetworkManager {
	...
	public static void registerPackets() {
		...
		//tkk
		INSTANCE.registerMessage(id++, SPTkkCustomData.class, SPTkkCustomData::toBytes, SPTkkCustomData::fromBytes, SPTkkCustomData::handle);
