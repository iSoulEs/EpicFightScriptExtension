...
public abstract class SpecialAttackSkill extends Skill {
	...
	public boolean canExecute(PlayerPatch<?> executer) {
		if (executer.isLogicalClient()) {
			...
			return executer.tkkPlayerLivingMotionAndSpecialSkill.getSkill(executer.getHoldingItemCapability(Hand.MAIN_HAND).getSpecialAttack(executer)) == this && executer.getOriginal().getVehicle() == null && (!executer.getSkill(this.category).isActivated() || this.activateType == ActivateType.TOGGLE);
		}
	}
